            ...
            <div className="grid max-w-md gap-10 row-gap-5 lg:max-w-screen-lg sm:row-gap-10 lg:grid-cols-3 xl:max-w-screen-lg sm:mx-auto">
                <div className="flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow">
                    <div className="text-center">
                        ...
                        <div className="mt-2 space-y-3">
                            <div className="text-gray-700">Everything is free</div>
                            <div className="text-gray-700">Limited services</div>
                ...
                <div className="relative flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow border-purple-400">
                    ...
                    <div className="text-center">
                        ...
                        <div className="mt-2 space-y-3">
                            <div className="text-gray-700">Everything is pro</div>
                            <div className="text-gray-700">Unlimited services</div>
                            <div className="text-gray-700">24/7 Support</div>
                        </div>
                    </div>
                    <div>
                ...
                <div className="flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow">
                    <div className="text-center">
                        ...
                        <div className="mt-2 space-y-3">
                            <div className="text-gray-700">Everything is business class</div>
                            <div className="text-gray-700">Unlimited services</div>
                            <div className="text-gray-700">24/7 Support</div>
                        </div>
                    </div>
